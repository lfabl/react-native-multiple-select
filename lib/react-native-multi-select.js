...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    customIndicatorIcon: PropTypes.element,
    ...
    customTextHeaderComponent: PropTypes.element,
    searchInputStyle: PropTypes.object,
    selectText: PropTypes.string,
    styleItemsContentContainer: ViewPropTypes.style,
    howManySelectedText: PropTypes.string,
    ...
    styleTagsContainer: ViewPropTypes.style,
  ...
  _getSelectLabel = () => {
    const { selectText, single, selectedItems, displayKey, howManySelectedText } = this.props;
    ...
    return `${selectText} (${selectedItems.length} ${howManySelectedText})`;
  };
  ...
  _getRow = item => {
    const { selectedItemIconColor, displayKey, styleRowList, itemStyle, itemContainerStyle } = this.props;
    return (
      <TouchableOpacity
        ...
        style={[
          ...
          itemContainerStyle ? itemContainerStyle(item, this._itemSelected(item)) : null
        ]}
      >
        <View>
      ...
      >
        {selector ? (
          ...
          <View>
              ...
              >
                <TouchableWithoutFeedback onPress={this._toggleSelector}>
                  ...
                  >
                    ...
                    {customIndicatorIcon ? customIndicatorIcon : <CustomIcon
            ...
            {customTextHeaderComponent && !single && !hideTags && selectedItems.length ? customTextHeaderComponent : null}
